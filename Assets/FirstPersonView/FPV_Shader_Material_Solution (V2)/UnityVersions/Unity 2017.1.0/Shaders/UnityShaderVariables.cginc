...
// ------------- FIRST PERSON VIEW 2 -------------
...
#if defined(FPV_LIGHT) // Used to enable/disable the projection matrix used during shadows calculations
    #define UNITY_MATRIX_P glstate_matrix_projection // FPV change
#elif defined(FPV_MOTION_VECTOR)
    #define UNITY_MATRIX_P _firstPersonProjectionMatrixCustom // FPV change
#else
    ...
    #define UNITY_MATRIX_MVP mul(UNITY_MATRIX_VP, unity_ObjectToWorld) // FPV change
...
// ------------- FIRST PERSON VIEW 2 -------------
        ...
        float4x4 _glFirstPersonProjectionMatrix;
    #endif
// -----------------------------------------------
